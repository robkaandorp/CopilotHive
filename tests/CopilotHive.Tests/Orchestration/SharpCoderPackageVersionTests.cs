...
/// <summary>
/// Verifies that the SharpCoder package reference is pinned to 0.16.0, which is required for the
...
{
    [Fact]
    public void SharpCoder_PackageReference_IsVersion0_16_0()
    {
