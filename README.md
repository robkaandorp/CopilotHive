...
- **Dashboard** — Blazor Server UI with goals browser (filterable/searchable, with Approve/Delete actions for Draft goals), goal detail with iteration timeline and approval controls, worker status, orchestrator view (Brain + Composer stats), live logs, and configuration
