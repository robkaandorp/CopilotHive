...
- **Dashboard** — Blazor Server UI with goals browser (filterable/searchable), goal detail with iteration timeline, worker status, orchestrator view (Brain + Composer stats), live logs, and configuration (with Markdown rendering for `.agents.md` files)
