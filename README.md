...
- **Per-goal Brain contexts** — The Brain now maintains independent agent sessions and LLM clients per goal, enabling truly parallel Brain planning and prompt crafting for concurrent goals without a global serialization gate.
