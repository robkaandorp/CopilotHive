...
- **Dashboard** — Blazor Server UI with goals browser (filterable/searchable), goal detail with iteration timeline and **clickable merge commit links**, worker status, orchestrator view (Brain + Composer stats), live logs, and configuration
